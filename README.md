...
**Reporting bugs**
Open an issue at [github.com/zap-coding-agent/zap-coding-agent/issues](https://github.com/zap-coding-agent/zap-coding-agent/issues). Include your OS, model/provider, the command you ran, and what you expected vs what happened. Attach the relevant lines from `~/.zap/audit.jsonl` if the problem is tool-related.
