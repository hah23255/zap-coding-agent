...
pub(super) async fn handle_tui_slash(
    ...
    if cmd == "/provider" {
        ...
        let entries: Vec<ProviderEntry> = vec![
            ...
            ProviderEntry { slug: "openrouter".into(), name: "OpenRouter".into(),                 hint: "200+ models — Claude, GPT, Gemini, Llama…".into(),   kind: ProviderKind::OpenAi,    models: vec!["anthropic/claude-opus-4".into(), "openai/gpt-4o".into(), "meta-llama/llama-3.3-70b-instruct".into(), "google/gemini-2.5-pro".into(), "Other…".into()], base_url: Some("https://openrouter.ai/api/v1/chat/completions".into()),          needs_key: true, coming_soon: false, auth_header: None,       ready: false },
            ...
            ProviderEntry { slug: "cerebras".into(),   name: "Cerebras".into(),                   hint: "llama3.3-70b · wafer-scale fastest inference".into(), kind: ProviderKind::OpenAi,    models: vec!["llama3.3-70b".into(), "llama3.1-70b".into(), "llama3.1-8b".into(), "qwen-3-32b".into(), "Other…".into()], base_url: Some("https://api.cerebras.ai/v1/chat/completions".into()),            needs_key: true, coming_soon: false, auth_header: None,       ready: false },
