...
impl Session {
    pub fn cmd_provider(&mut self, config: &Config) {
        ...
        let providers: Vec<ProviderDef> = vec![
            ...
            ProviderDef { slug: "openrouter", name: "OpenRouter",                 hint: "200+ models — Claude, GPT, Gemini, Llama…",   kind: ProviderKind::OpenAi,    models: vec!["anthropic/claude-opus-4".into(), "openai/gpt-4o".into(), "meta-llama/llama-3.3-70b-instruct".into(), "google/gemini-2.5-pro".into(), "Other…".into()], base_url: Some("https://openrouter.ai/api/v1/chat/completions"),          needs_key: true,  coming_soon: false, auth_header: None,       ready: false },
            ...
            ProviderDef { slug: "cerebras",   name: "Cerebras",                   hint: "llama3.3-70b · wafer-scale fastest inference", kind: ProviderKind::OpenAi,    models: vec!["llama3.3-70b".into(), "llama3.1-70b".into(), "llama3.1-8b".into(), "qwen-3-32b".into(), "Other…".into()], base_url: Some("https://api.cerebras.ai/v1/chat/completions"),            needs_key: true,  coming_soon: false, auth_header: None,       ready: false },
